...
class ExclusiveCartScreen extends StatefulWidget {
  const ExclusiveCartScreen({super.key});

  @override
  State<ExclusiveCartScreen> createState() => _CartScreenState();
}

class _CartScreenState extends State<ExclusiveCartScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildPaymentRow('Order Amount', '\$200', const Color.fromARGB(255, 255, 255, 255)),
                    const SizedBox(height: 8),
