...
class ExclusiveSingleDetail extends StatefulWidget {
  const ExclusiveSingleDetail({super.key});

  @override
  State<ExclusiveSingleDetail> createState() => _SingleDetailScreenState();
}

class _SingleDetailScreenState extends State<ExclusiveSingleDetail> {
      ...
      children: [
        ...
        TextButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ExclusiveGuideScreen()),
            );
          },
          child: const Text(
            'Size Guide',
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ExclusiveDesignerProfile(),
                  ),
                );
              },
              child: Container(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ExclusiveCartScreen(),
                  ),
                );
              },
              child: Container(
